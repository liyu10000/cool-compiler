...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    /* Feature list: attributes and methods of classes */
	...
	/* formal parameters: parameters of methods of classes */
	...
	expr_param	: expr { $$ = single_Expressions($1); }
				| expr_param ',' expr { $$ = append_Expressions($1, single_Expressions($3)); }
				| { $$ = nil_Expressions(); }
				| error ',' { ; }
	...
	expr		: OBJECTID ASSIGN expr { $$ = assign($1, $3); }
				...
				| expr '.' OBJECTID '(' expr_param ')' { $$ = dispatch($1, $3, $5); }
				| OBJECTID '(' expr_param ')' { $$ = dispatch(object(idtable.add_string("self")), $1, $3); }
				| expr '@' TYPEID '.' OBJECTID '(' expr_param ')' { $$ = static_dispatch($1, $3, $5, $7); }
